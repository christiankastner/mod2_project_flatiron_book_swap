class ShelfBook < ApplicationRecord
    ...
    has_many :passive_relationships, class_name: "Request", foreign_key: :swappee_shelf_book_id, dependent: :destroy
    has_many :requests, through: :passive_relationships, source: :swapper
    belongs_to :shelf 
    belongs_to :book
